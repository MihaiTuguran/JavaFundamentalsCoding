...
public class ComplexNumber {
    ...
    // this is not the best practice, but it's good enough for now in order to DEEP copy an instance
    public ComplexNumber(ComplexNumber numberToCopy){
        this.real = numberToCopy.getReal();
        this.imaginary = numberToCopy.getImaginary();
    }
